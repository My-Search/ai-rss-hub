...
public class DatabaseInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        jdbcTemplate.execute("CREATE TABLE IF NOT EXISTS retry_queue (" +
                "id INTEGER PRIMARY KEY AUTOINCREMENT, " +
                "user_id INTEGER NOT NULL, " +
                "rss_item_id INTEGER NOT NULL, " +
                "source_id INTEGER NOT NULL, " +
        ...
        jdbcTemplate.execute("CREATE INDEX IF NOT EXISTS idx_retry_queue_user_id ON retry_queue(user_id)");
        jdbcTemplate.execute("CREATE INDEX IF NOT EXISTS idx_retry_queue_retry_count ON retry_queue(retry_count, max_retries)");
    }
}
